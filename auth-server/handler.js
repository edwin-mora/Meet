...
module.exports.getAcessToken = async (event) => {
  // the values used to intatniate the OAuthClient are at the top of the file
...
const credentials = {
  ...
  redirect_uris: ["https://edwin-mora.github.io/Meet/"],
  javascript_origins: ["https://edwin-mora.github.io", "http://localhost:8080"],
};
